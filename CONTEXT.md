...
- 首页已完成独立 Demo 阶段的收口：Jasper #30 作为主站基线，其他方案保留为开发小组宣传网站；仅 #30 已完成并关闭，其余未完成票据保持开放，后续实现继续沿用原验收并按需建立新的开发 issue 和 PR。旧“校园技术成果展”降为候选，不是已定视觉方向。规划见 `docs/product/main-site-baseline.md`。
